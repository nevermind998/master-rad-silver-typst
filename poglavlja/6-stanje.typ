...
Тестови се покрећу из локала и постоје одређени кораци који треба да буду испуњени како би се покренули. Ако се приступа из терминала потребно је прво да се осигура аутентификација са Azure  налогом коришћењем команди:
