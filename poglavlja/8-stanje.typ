...
Пример дефинисања поруџбине у оквиру апликација приказано је на слици @slika-7-1-2.
...
Након дефинисања архитектуре и сервиса, треба да се генерише апликације. Smithy модел генерише OpenAPI спецификације, серверски шаблони и клијентске библиотеке, што је основа за имплементацију микросервиса. Затим се додаје пословна логика, која је у овом случају микросервина апликација која подржава обраду поруџбине. Детаљније о самој архитектури је описано раније, а на слици @slika-7-5-1-1 може се видети приказ архитектуре генерисано уз помоћ Structurizr DSL. 
